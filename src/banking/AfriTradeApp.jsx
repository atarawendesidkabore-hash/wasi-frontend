...
export default function AfriTradeApp({
  ...
  const tabs = [
    ...
    ...((isManager || isTeller)
      ? [{ id: "approvals", label: isManager ? "Validations" : "Suivi", icon: Shield }]
      : []),
